      ...
      {displaySession.map((session) => {
        return (
          <div className="row">
            ...
            <div className="row">
              <div className="col-7">{session.knowledge}</div>
              <div className="col-5">{session.moments}</div>
            </div>
            <div className="row">{session.storylines}</div>
          </div>
        );
      })}
    </div>
...
//session.moments ==> wrap component
